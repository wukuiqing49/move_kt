...
import com.wkq.net.api.ApiUSTVShow;
...
public class ApiRequest<Observable extends io.reactivex.Observable<Result<BaseData>>, BaseData extends BaseInfo> {
    ...
    private static final String BASE_US_TV_SHOW = "http://www.yyetss.com/";



    //动态配置BaseUrl
    public static <T> String serviceEndpoint(Class<T> clazz) {
        if (clazz == ApiUSTVShow.class) return BASE_US_TV_SHOW;
        return BASE_US_TV_SHOW;
    }
