package com.wkq.move.module.main.ui.widget;
...
//            if (index == 2) {
//                if (releaseListener != null) releaseListener.onClick(v);
//                return;
//            }
...
//    private OnClickListener releaseListener;
//
//    public void setReleaseEventListener(OnClickListener listener) {
...
//        if (index==2)return;
    ...
    public static class Tab {
        ...
        private int mSignCountMarginRight = 50;
        private int mSignCountMarginTop = 10;
        /**
...
//                signCountLp.addRule(RelativeLayout.RIGHT_OF, R.id.qmui_tab_segment_item_id);
                signCountLp.addRule(RelativeLayout.ALIGN_PARENT_RIGHT, TRUE);
                signCountLp.addRule(RelativeLayout.ALIGN_PARENT_TOP, TRUE);

                mSignCountTextView.setLayoutParams(signCountLp);
                mSignCountTextView.setTextSize(10);
        ...
        public void showSignCountView(Context context, int count) {
            ...
            if (count != 0) {
                // 显示未读数
                signCountLp.height = ViewGroup.LayoutParams.WRAP_CONTENT;
                mSignCountTextView.setLayoutParams(signCountLp);
    ...
    public class TabAdapter extends QMUIItemViewsAdapter<Tab, TabItemView> {
        ...
        protected void bind(Tab item, TabItemView view, int position) {
            ...
            if (mMode == MODE_FIXED) {
                ...
                lp.addRule(RelativeLayout.ALIGN_PARENT_LEFT, (gravity & Gravity.LEFT) == Gravity.LEFT ? TRUE : 0);
                lp.addRule(RelativeLayout.CENTER_HORIZONTAL, (gravity & Gravity.CENTER) == Gravity.CENTER ? TRUE : 0);
                lp.addRule(RelativeLayout.ALIGN_PARENT_RIGHT, (gravity & Gravity.RIGHT) == Gravity.RIGHT ? TRUE : 0);
...
//    }
    ...
    public class TabItemView extends RelativeLayout {
        ...
        public TabItemView(Context context) {
            ...
            tvLp.addRule(RelativeLayout.CENTER_VERTICAL, TRUE);
